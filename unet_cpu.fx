graph():
    ...
    %empty : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([10, 9216, 9216],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_1 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([10, 9216, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_2 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([10, 9216, 9216],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_3 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([10, 9216, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_4 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([20, 2304, 2304],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_5 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([20, 2304, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_6 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([20, 2304, 2304],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_7 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([20, 2304, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_8 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([40, 576, 576],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_9 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([40, 576, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_10 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([40, 576, 576],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_11 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([40, 576, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_12 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([40, 144, 144],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_13 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([40, 144, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_14 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([40, 576, 576],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_15 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([40, 576, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_16 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([40, 576, 576],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_17 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([40, 576, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_18 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([40, 576, 576],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_19 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([40, 576, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_20 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([20, 2304, 2304],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_21 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([20, 2304, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_22 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([20, 2304, 2304],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_23 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([20, 2304, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_24 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([20, 2304, 2304],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_25 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([20, 2304, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_26 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([10, 9216, 9216],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_27 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([10, 9216, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %empty_28 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([10, 9216, 9216],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %convert_element_type_100 : [#users=1] = call_function[target=torch.ops.prims.convert_element_type](args = (%zero__28, torch.float32), kwargs = {})
    %convert_element_type_101 : [#users=1] = call_function[target=torch.ops.prims.convert_element_type](args = (%_unsafe_view_214, torch.float32), kwargs = {})
    %convert_element_type_102 : [#users=1] = call_function[target=torch.ops.prims.convert_element_type](args = (%transpose_28, torch.float32), kwargs = {})
    %baddbmm_28 : [#users=1] = call_function[target=torch.ops.aten.baddbmm](args = [%convert_element_type_100, %convert_element_type_101, %convert_element_type_102], kwargs = {beta: 0, alpha: 0.125})
    %_softmax_28 : [#users=1] = call_function[target=torch.ops.aten._softmax](args = (%baddbmm_28, -1, False), kwargs = {})
    %convert_element_type_103 : [#users=2] = call_function[target=torch.ops.prims.convert_element_type](args = (%_softmax_28, torch.float16), kwargs = {})
    %detach_142 : [#users=0] = call_function[target=torch.ops.aten.detach](args = (%convert_element_type_103,), kwargs = {})
    %bmm_43 : [#users=1] = call_function[target=torch.ops.aten.bmm](args = (%convert_element_type_103, %_unsafe_view_216), kwargs = {})
    ...
    %convert_element_type_104 : [#users=1] = call_function[target=torch.ops.prims.convert_element_type](args = (%add_313, torch.float32), kwargs = {})
    %var_mean_100 : [#users=2] = call_function[target=torch.ops.aten.var_mean](args = (%convert_element_type_104, [2]), kwargs = {correction: 0, keepdim: True})
    ...
    %empty_29 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([10, 9216, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %convert_element_type_105 : [#users=1] = call_function[target=torch.ops.prims.convert_element_type](args = (%add_316, torch.float32), kwargs = {})
    %var_mean_101 : [#users=2] = call_function[target=torch.ops.aten.var_mean](args = (%convert_element_type_105, [2]), kwargs = {correction: 0, keepdim: True})
    ...
    %convert_element_type_106 : [#users=1] = call_function[target=torch.ops.prims.convert_element_type](args = (%view_534, torch.float32), kwargs = {})
    %var_mean_102 : [#users=2] = call_function[target=torch.ops.aten.var_mean](args = (%convert_element_type_106, [2, 3]), kwargs = {correction: 0, keepdim: True})
    ...
    %convert_element_type_107 : [#users=1] = call_function[target=torch.ops.prims.convert_element_type](args = (%view_536, torch.float32), kwargs = {})
    %var_mean_103 : [#users=2] = call_function[target=torch.ops.aten.var_mean](args = (%convert_element_type_107, [2, 3]), kwargs = {correction: 0, keepdim: True})
    ...
    %convert_element_type_108 : [#users=1] = call_function[target=torch.ops.prims.convert_element_type](args = (%view_538, torch.float32), kwargs = {})
    %var_mean_104 : [#users=2] = call_function[target=torch.ops.aten.var_mean](args = (%convert_element_type_108, [2, 3]), kwargs = {correction: 0, keepdim: True})
    ...
    %convert_element_type_109 : [#users=1] = call_function[target=torch.ops.prims.convert_element_type](args = (%add_329, torch.float32), kwargs = {})
    %var_mean_105 : [#users=2] = call_function[target=torch.ops.aten.var_mean](args = (%convert_element_type_109, [2]), kwargs = {correction: 0, keepdim: True})
    ...
    %empty_30 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([10, 9216, 9216],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %convert_element_type_110 : [#users=1] = call_function[target=torch.ops.prims.convert_element_type](args = (%add_332, torch.float32), kwargs = {})
    %var_mean_106 : [#users=2] = call_function[target=torch.ops.aten.var_mean](args = (%convert_element_type_110, [2]), kwargs = {correction: 0, keepdim: True})
    ...
    %empty_31 : [#users=1] = call_function[target=torch.ops.aten.empty](args = ([10, 9216, 77],), kwargs = {dtype: torch.float16, device: cuda, pin_memory: False})
    ...
    %convert_element_type_111 : [#users=1] = call_function[target=torch.ops.prims.convert_element_type](args = (%add_335, torch.float32), kwargs = {})
    %var_mean_107 : [#users=2] = call_function[target=torch.ops.aten.var_mean](args = (%convert_element_type_111, [2]), kwargs = {correction: 0, keepdim: True})
    ...
    %convert_element_type_112 : [#users=1] = call_function[target=torch.ops.prims.convert_element_type](args = (%view_568, torch.float32), kwargs = {})
    %var_mean_108 : [#users=2] = call_function[target=torch.ops.aten.var_mean](args = (%convert_element_type_112, [2, 3]), kwargs = {correction: 0, keepdim: True})
