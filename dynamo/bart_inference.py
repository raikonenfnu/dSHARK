...
base_model = BartForCausalLM.from_pretrained("facebook/bart-base")
...
my_config.encoder_layers = 2
my_config.decoder_layers = 2
my_config.vocab_size = 8192
my_config.attention_dropout=0.0
my_config.activation_dropout=0.0
my_config.classifier_dropout=0.0
net = BartForCausalLM(my_config)
