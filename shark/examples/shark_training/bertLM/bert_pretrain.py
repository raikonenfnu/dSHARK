...
def train_bert_hdf5(flags):
    ...
    def train_loop_fn(model, optimizer, train_loader, epoch, global_step, training_ustep, running_loss, throughput_input, device):
        max_grad_norm = 1.0
        ...
        for i, data in enumerate(train_loader):
            ...
            if training_ustep % flags.grad_accum_usteps == 0:
                ...
                print("running_loss_cpu:", running_loss_cpu)
                running_loss.zero_()
        ...
        return global_step, training_ustep, running_loss, running_loss_cpu, throughput_input.get_throughput()
    ...
    while True:
        ...
        for f in range(file_start_idx + 1, len(files)):
            ...
            global_step, training_ustep, running_loss, final_loss, last_throughput = train_loop_fn(
                model, optimizer, train_dataloader, epoch, global_step, training_ustep, running_loss, throughput, device)
            ...
            if is_root and not extract_graphs_only:
                ...
                print('Epoch {} step {} file index {} end {} loss {} perf {} seq/sec (at train microstep {} time {} from beginning time {})'.format(
                    epoch, global_step, f, time.asctime(), final_loss, last_throughput, training_ustep, final_time, train_start), flush=True)
                ...
                metric_data = [
                    ...
                    Metric("Throughput", last_throughput, "seq/s", additional_data)
                ]
